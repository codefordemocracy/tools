    ...
    <div>
      <div class="bg-xlight p-5 mb-4" v-for="list in chunks[page-1]">
        ...
        <div class="text-xs mt-3">
          <a :href="'/view/list/?id=' + list.id" class="text-blue mr-3" v-if="_.includes(actions, 'view')" v-on:click.prevent="POPUP(event.currentTarget.href, 'popup-list-' + _.uniqueId(), ratio, window)">View Entities</a>
